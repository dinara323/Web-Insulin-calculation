...
exports.insulinServices = [
    {
        ...
        description: 'Расчёт болюсной дозы инсулина с учётом хлебных единиц.',
        isf: 2.5,
        insulinPerXe: 1,
        targetGlucose: 6,
        status: 'опубликован',
    ...
    },
    {
        ...
        description: 'Расчёт с учётом текущего и целевого уровня глюкозы.',
        isf: 3,
        insulinPerXe: 1,
        targetGlucose: 6,
        status: 'опубликован',
    ...
    },
    {
        ...
        description: 'Расчёт количества инсулина на основе количества ХЕ.',
        isf: 2.5,
        insulinPerXe: 1.2,
        targetGlucose: 6,
        status: 'опубликован',
    ...
    },
    {
        ...
        description: 'Индивидуальный набор параметров для расчёта.',
        isf: 4,
        insulinPerXe: 0.8,
        targetGlucose: 5.5,
        status: 'опубликован',
    ...
    },
    {
        ...
        description: 'Черновая версия услуги, доступная на странице добавления.',
        isf: 2.5,
        insulinPerXe: 1,
        targetGlucose: 6,
        status: 'черновик',
